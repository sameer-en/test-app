<?php 
$arr['data'][] = array("fname"=>'Sam','lname'=>'kodilkar');
$arr['data'][] = array("fname"=>'Sam1','lname'=>'kodilkar1');
$arr['data'][] = array("fname"=>'Sam2','lname'=>'kodilkar2');
$arr['data'][] = array("fname"=>'Sam3','lname'=>'kodilkar3');
